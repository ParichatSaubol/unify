...
const InputSearchCourse: FunctionComponent<Props> = ({
  value,
  onChange,
  placeholder,
  disabled,
      ...
      <View>
        {!disabled ? (
          <TextInput
            numberOfLines={1}
            multiline={false}
            style={[Fonts.text16, styles.input, { color: 'black' }]}
...
InputSearchCourse.defaultProps = {
  onChange: () => {},
  value: '',
  placeholder: '',
  disabled: false,
...
export default InputSearchCourse;
