...
type Props = NativeStackScreenProps<AuthenticationParamsList, 'ForgotPassword'>;
        ...
        >
          ...
          <View style={[Layout.col, Layout.fullWidth, Layout.alignItemsStart]}>
            ...
            <Text style={[Fonts.text21, { color: Colors.gray600 }]}>
              {t('authentication:forgot.desctiption')}
            </Text>
          </View>
          <View>
            <Input placeholder={t('authentication:forgot.placeholder')} />
          </View>
          <View
            style={[
              Layout.rowHCenter,
          ...
          >
            <View style={[Layout.rowHCenter, Layout.gap10]}>
              ...
              <Text style={[Fonts.text16, { color: Colors.gray600 }]}>
                {t('authentication:forgot.validation')}
              </Text>
            </View>
          </View>
          <View
          ...
          >
            <Button
              title={t('authentication:forgot.next')}
              fullWidth
              onPress={() => {
